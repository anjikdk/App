...
public class School {
	...
	public static void main(String[] args) {
		...
		List<Student> students = s.createStudent();
	...
	{
		List<String> stdLidt = students.stream().filter(s -> s.getSubjects().contains("History")).map(s -> s.getName()).collect(Collectors.toList());
